...
$("#btnBuscar").click(function () {
    ...
    fetch(`/Sale/SalesHistory?salesNumber=${numeroVenta}&initialDate=${fechaInicio}&finalDate=${fechaFin}`)
        .then(response => {
...
$("#tbventa tbody").on("click", ".btn-info", function () {
    ...
    $("#linkImprimir").attr("href", `/Sale/ShowPdf?saleNumber=${d.numeroVenta}`)
